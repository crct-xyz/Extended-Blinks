...
function validatedQueryParams(requestUrl: URL) {
	...
	if (requestUrl.searchParams.get("txIndex")) {
		txIndex = Number.parseInt(requestUrl.searchParams.get("txIndex")!);
	}
	if (requestUrl.searchParams.get("newThreshold")) {
		newThreshold = Number.parseInt(
			requestUrl.searchParams.get("newThreshold")!,
		);
	}
	...
	if (requestUrl.searchParams.get("txnIndex")) {
		txnIndexForChecking = Number.parseInt(
			requestUrl.searchParams.get("txnIndex")!,
		);
	}
